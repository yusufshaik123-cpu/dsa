# Tries [Theory, Practice]

Detailed progress tracker for Step 17 of the Striver A2Z DSA Sheet.

---

## 📂 Lec 1: Theory

### 📄 Implement Trie I (Insert, Search, StartsWith)
- **Difficulty**: Medium
- **Problem Pattern**: Trie
- **Official Problem Link**: [Primary Practice Link](https://leetcode.com/problems/implement-trie-prefix-tree/)
...
- **Similar Problems**:
  - [Related problem A](https://leetcode.com/problems/implement-trie-prefix-tree/)
  - [Related problem B](https://leetcode.com/problems/implement-trie-prefix-tree/)
- **Harder Follow-up Problems**:
  - [Advanced follow-up A](https://leetcode.com/problems/implement-trie-prefix-tree/)
...
- **Difficulty**: Medium
- **Problem Pattern**: Trie/Bitwise
- **Official Problem Link**: [Primary Practice Link](https://leetcode.com/problems/maximum-xor-of-two-numbers-in-an-array/)
- **Alternative Practice Links**:
...
- **Hints**:
  ...
  - Hint 3: Check time complexity constraints to select the optimal approach (e.g. Binary Search for sorted arrays).
- **Similar Problems**:
  - [Related problem A](https://leetcode.com/problems/maximum-xor-of-two-numbers-in-an-array/)
  - [Related problem B](https://leetcode.com/problems/maximum-xor-of-two-numbers-in-an-array/)
- **Harder Follow-up Problems**:
  - [Advanced follow-up A](https://leetcode.com/problems/maximum-xor-of-two-numbers-in-an-array/)
- **Learning Lists**: Not Included
- **Tags**: Trie/Bitwise, Medium, Interview
...
- **Difficulty**: Hard
- **Problem Pattern**: Trie/Bitwise
- **Official Problem Link**: [Primary Practice Link](https://leetcode.com/problems/maximum-xor-with-an-element-from-array/)
- **Alternative Practice Links**:
...
- **Hints**:
  ...
  - Hint 3: Check time complexity constraints to select the optimal approach (e.g. Binary Search for sorted arrays).
- **Similar Problems**:
  - [Related problem A](https://leetcode.com/problems/maximum-xor-with-an-element-from-array/)
  - [Related problem B](https://leetcode.com/problems/maximum-xor-with-an-element-from-array/)
- **Harder Follow-up Problems**:
  - [Advanced follow-up A](https://leetcode.com/problems/maximum-xor-with-an-element-from-array/)
- **Learning Lists**: Not Included
- **Tags**: Trie/Bitwise, Hard, Interview
...
## 📈 Step 17 Dashboard & Summary

### 🏁 Lectures & Topics Covered
- **Lec 1: Theory** - 2 Problems
- **Lec 2: Practice** - 4 Problems
